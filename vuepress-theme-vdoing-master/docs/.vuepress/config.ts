...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  base: "/chaos_front/", // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        link: '/backend/',
        items: [
          { text: 'java', link: '/pages/1b141f/' },
          { text: 'spring', link: '/pages/b2111e/' },
          { text: 'springboot', link: '/pages/0244f5/' },
      ...
      // },
      {
        ...
        link: '/linux/',
        items: [
          { text: 'linux命令', link: '/pages/271e21/' },
          { text: 'linux安装软件', link: '/pages/e66dd1/' },
          { text: 'linux脚本', link: '/pages/78c56a/' },
        ],
      },
      {
        text: '开发工具',
        link: '/tools/',
        items: [
          { text: 'idea', link: '/pages/c36f84/' },
          { text: 'vscode', link: '/tags/' },
    ...
    repo: 'https://github.com/chaos1973/chaos_front', // 导航栏右侧生成Github链接
    ...
    author: {
      name: '~chao', // 必需
      link: 'https://github.com/chaos1973', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'chaos | <a href="https://github.com/chaos1973/chaos_front" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
